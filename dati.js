...
const BIO = {
    titolo: "Chi Sono",
    descrizione: "Mi chiamo Gregorio Pedrini e la montagna è, da sempre, la mia casa. Nato e cresciuto tra le vette della Garfagnana, ho trasformato questa passione in una professione, completando nel 2025 il corso per diventare Aspirante Guida Alpina. <br><br> Il mio percorso accademico in Scienze Naturali e Ambientali mi permette di accompagnarti non solo lungo pareti e sentieri, ma anche alla scoperta dell'equilibrio ecologico e della geologia che rendono unici i nostri massicci. <br><br> Amo definirmi un ricercatore di itinerari dimenticati: mi diletto nel ridare vita a vecchie vie, relazionandole e rinnovandone le protezioni per renderle nuovamente fruibili. Questa dedizione mi ha portato a diventare l'autore della prossima guida "Vie Lunghe in Apuane", edita da Versante Sud (2026). <br><br> Che si tratti di Apuane o di Alpi, organizzo uscite su misura dove sicurezza, conoscenza del territorio e divertimento sono sempre al primo posto.`,
